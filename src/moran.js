...
export async function calculateMoran(featureCollection, valueField, opts = {}) {
    var _a;
    Object.assign({
    ...
    featureCollection.features.forEach((feature, i) => {
        ...
        if (feature.properties != null) {
            ...
            let z = undefined;
            if (!((_a = opts.weightMatrix) === null || _a === void 0 ? void 0 : _a.map.has(id))) {
                z = undefined;
                value = undefined;
            }
            localResults.push({
    ...
    const valueMean = mean(localResults, d => d.value);
    const valueStd = deviation(localResults, d => d.value);
    ...
    for (const localResult of localResults) {
        const areaWeightEntry = (_a = opts.weightMatrix) === null || _a === void 0 ? void 0 : _a.getWeights(localResult.id);
        if (areaWeightEntry == undefined)
            continue;
...
export async function calculatePValues(moranResult, opts = {}) {
    // Object.assign({
...
function pByReference(val, ref, permutations) {
...
function unadjustedLocalMoran(z, neighborZs, weights) {
    const validNeighborZs = [];
    let validWeights = [];
...
export function calculateWeightMatrix(featureCollection, method = "queen") {
...
export class WeightMatrix {
    ...
    getWeight(id1, id2) {
        var _a;
        return (_a = this.map.get(id1)) === null || _a === void 0 ? void 0 : _a.get(id2);
    }
    set(id1, id2, value) {
